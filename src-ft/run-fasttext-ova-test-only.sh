...
for type in "${types[@]}"; do
  ...
  ./fastText-0.9.2/fasttext test $FOLDER/${type}_unfiltered_model.bin $FOLDER/${type}_unfiltered.test.txt 2 0.3
  ...
  echo "***" $b
    ...
    ./fastText-0.9.2/fasttext test $FOLDER/${type}_${b}_filtered_model.bin $FOLDER/${type}_${b}_filtered.test.txt 2 0.3
